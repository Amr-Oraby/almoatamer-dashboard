          ...
          <ul className="space-y-2 px-4 [direction:ltr] rtl:[direction:rtl]">
            ...
            {bottomItems.map((item) => {
              ...
              if (item.href === '/transactions') {
                return (
                  <PermissionGuard permission="index-transactions" type="element" key={item.href}>
                    <li>{linkElement}</li>
                  </PermissionGuard>
                );
              }
              ...
              >
                ...
                <CollapsibleContent className="space-y-1 pt-1 pb-2">
                  {rolesItems.map((item) => {
                    ...
                    if (item.href === '/roles/admins') {
                      return (
                        <PermissionGuard permission="index-admin" type="element" key={item.href}>
                          {linkElement}
                        </PermissionGuard>
                      );
                    }
