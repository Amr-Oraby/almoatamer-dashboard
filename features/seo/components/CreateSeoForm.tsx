...
import { useCreateSeo } from "../hooks";
...
export function CreateSeoForm() {
    const t = useTranslations("Dashboard");
    const router = useRouter();
    const localeCode = useLocale();
    const { mutateAsync: createSeo, isPending } = useCreateSeo();

    const { register, handleSubmit, formState: { errors } } = useForm<CreateSeoFormValues>({
